package com.pilates.thais.almeida.repository;                                         
  ...
  public interface AulaRepository extends JpaRepository<Aula, Integer> {                
      ...
      List<Aula> findAllByDataAulaAfterAndTurma_Id(LocalDate dataAulaAfter, Integer     
  turmaId);                                                                             
                                                                                        
      Optional<Aula>                                                                    
  findFirstByTurma_IdAndDataAulaGreaterThanEqualOrderByDataAulaAsc(Integer turmaId,     
  LocalDate data);                                                                      
  ...
  +                                                                                     
             "FROM Aula a WHERE a.dataAula >= :desde GROUP BY FUNCTION('DATE_FORMAT',   
  a.dataAula, '%Y-%m'), a.marcada")                                                     
